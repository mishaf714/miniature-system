...
REVIEWS = [
    ...
    gd(85100833, "Good Company", 0.6, ["Overall satisfaction"], [], "Positive overall."),
    ...
    gd(99227341, "Excruciating interview process for contractors", -0.8, [], ["Organization & process"],
       "Strongly negative about the contractor hiring process."),
